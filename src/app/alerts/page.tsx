        ...
        <div className="mx-auto max-w-7xl px-6 md:px-10">
          ...
          <ul className="mt-8 space-y-3">
            {roadStatuses.map((road) => (
              ...
              >
                <div>
                  <h3 className="font-display text-lg text-glacier">{road.route}</h3>
                  <p className="mt-2 text-sm leading-relaxed text-ice">{road.note}</p>
                  <p className="mt-2 text-xs text-ice">Updated {road.updated}</p>
                </div>
                <span
