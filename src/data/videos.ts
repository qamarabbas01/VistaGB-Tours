import type { DestinationVideo } from './types';

/** Homepage film reel — one clip per travel-video theme. */
export const featuredVideos: DestinationVideo[] = [
  {
  ...
  },
  {
    ...
    caption: 'A classic upper Hunza trek across ice and high pasture.',
    theme: 'trekking',
  ...
  },
  {
    ...
    caption: 'The 4x4 approach toward Nanga Parbat.',
    theme: 'jeep',
  ...
  },
  {
    ...
    caption: 'Snowbound travel from Chilas toward Hunza.',
    theme: 'snowfall',
    poster: '/images/commons/ba4b0d53d291cba4.jpg',
  },
  {
    ...
    caption: 'Orchard season along the Karakoram Highway.',
    theme: 'blossom',
  ...
  },
  {
    ...
    caption: 'Lakes, forts, and orchard gold through the seasons.',
    theme: 'autumn',
