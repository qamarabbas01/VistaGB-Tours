...
export const nagarGuide: RegionGuide = {
  ...
  population:
    'Tens of thousands across Nagar District villages; smaller and less tourist-dense than Hunza.',
  ...
  trekkingRoutes: [
    ...
    },
    {
      ...
      detail:
        'Classic multi-day trek from Minapin with towering north-face views.',
  ...
  suggestedItinerary: [
    {
      ...
      summary:
        'Cross from Hunza, visit Nagar Khas, continue to Hopper for glacier light.',
    ...
    },
    {
      ...
      summary:
        'Hopper Glacier walks; optional evening return to Hunza or night in Minapin.',
    ...
    },
    {
      ...
      summary:
        'Rakaposhi base camp or begin the Rush Lake approach with a guide.',
