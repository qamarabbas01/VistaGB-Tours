...
export const astoreGuide: RegionGuide = {
  ...
  population:
    'Scattered valley settlements; far less dense than Gilgit or Skardu towns.',
  ...
  suggestedItinerary: [
    {
      ...
      summary:
        'Drive in, overnight in Astore or continue toward Rama if daylight allows.',
      stops: ['Astore'],
    },
    {
      day: 'Day 2',
  ...
  famousFoods: [
    {
      ...
      detail:
        'Hearty, simple meals after the hike in — vegetarian options usual.',
    },
  ],
  hotels: [
    {
  ...
  restaurants: [
    {
      ...
      detail:
        'All meals are typically lodge-provided; limited independent restaurants.',
    },
  ],
  trekkingRoutes: [
    {
  ...
  suggestedItinerary: [
    {
      ...
      title: 'Drive & hike in',
      summary:
        'Reach Tato by jeep, hike to Fairy Meadows, sunset on Nanga Parbat.',
...
export const ghizerGuide: RegionGuide = {
  ...
  population:
    'Spread across long valley corridors; small town hubs at Gahkuch and along the Ghizer road.',
  ...
  restaurants: [
    {
      ...
      detail:
        'Trout and home-style meals; few independent restaurants outside hubs.',
    },
  ],
  trekkingRoutes: [
    {
