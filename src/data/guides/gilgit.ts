...
export const gilgitGuide: RegionGuide = {
  ...
  population:
    "Gilgit city and surrounds form one of GB's largest urban populations (city proper roughly 200,000+ in the wider urban area).",
  languages: [
    'Shina',
    'Urdu',
    'Burushaski (visitors)',
    'Wakhi (through traffic)',
    'English',
  ],
  famousFoods: [
    {
  ...
  restaurants: [
    {
      ...
      detail:
        'Best variety of local and Pakistani dishes in northern Pakistan.',
    },
    {
  ...
  trekkingRoutes: [
    {
      ...
      detail:
        'Jeep access with short walks among pine forests and coloured lakes.',
      placeSlug: 'naltar-valley',
      difficulty: 'easy',
    },
    {
  ...
  suggestedItinerary: [
    {
      ...
      summary:
        'Bazaar, food street, and optional Kargah Buddha in the afternoon.',
    ...
    },
    {
      ...
      summary:
        'Full day in a side valley, return to Gilgit or continue toward Hunza.',
