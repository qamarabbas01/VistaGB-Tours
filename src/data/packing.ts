...
export const packingSections: PackingSection[] = [
  {
    ...
    items: [
      {
        id: 'layers',
        label: 'Layered clothing (base, fleece, windproof shell)',
      },
  ...
  },
  {
    ...
    items: [
      {
        id: 'shoulder',
        label: 'Spring/autumn: extra warm layer and light gloves',
      },
      { id: 'rain', label: 'Summer treks: rain shell and trekking poles' },
      {
        id: 'highcamp',
        label: 'Deosai / high camps: beanie, gloves, heavier insulation',
      },
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'permits',
        label: 'Restricted-area permits (if your operator arranged them)',
      },
    ],
  },
];
